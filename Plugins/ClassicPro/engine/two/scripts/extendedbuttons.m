...
Global Button openBut, nextBut, prevBut;

System.onScriptLoaded() {
	myGroup = getScriptGroup();
	openBut = myGroup.findObject("two.playback.ejectvol");
	nextBut = myGroup.findObject("two.playback.next");
	prevBut = myGroup.findObject("two.playback.prev");
}
