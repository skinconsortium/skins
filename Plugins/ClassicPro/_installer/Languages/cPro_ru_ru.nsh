...
; Finish Page	
	...
	LangString CPro_FinishPage_4 ${LANG_RUSSIAN} "Завершить"	
	LangString CPro_FinishPage_5 ${LANG_RUSSIAN} "Что вы хотите сделать далее?"
	LangString CPro_FinishPage_6 ${LANG_RUSSIAN} "Найти больше обложек и дополнений аддона ${CPRO_NAME} на сайте"
	LangString CPro_FinishPage_7 ${LANG_RUSSIAN} "Запустить Winamp"
	LangString CPro_FinishPage_8 ${LANG_RUSSIAN} "Сделать ${CPRO_NAME} оболочкой по умолчанию"
...
; Warnings
	LangString CPro_Warning_CreateMutex		${LANG_RUSSIAN}	"Инсталятор ${CPRO_NAME} версии ${CPRO_VERSION} уже запущен."
	LangString CPro_Warning_No_Winamp		${LANG_RUSSIAN} "На компьютере не обнаружен Winamp.$\r$\nПожалуйста, установите последнюю версию с Winamp.com,$\r$\nперед установкой ${CPRO_NAME} версии ${CPRO_VERSION}.$\r$\nУстановка будет прервана."
	LangString CPro_Warning_Low_Version		${LANG_RUSSIAN} "Для ${CPRO_NAME} версии ${CPRO_VERSION} требуется Winamp версии ${CPRO_WINAMP_VERSION} или выше.$\r$\nПожалуйста, обновите свою версию Winamp (У вас установлена: $R0).$\r$\nУстановка будет прервана."
	LangString CPro_Warning_AtLeast_2000	${LANG_RUSSIAN} "Извините, ваша система не поддерживается. ${CPRO_NAME} версии ${CPRO_VERSION} работает только на Windows 2000 или выше.$\r$\nУстановка будет прервана."
...
; Close all instances of Winamp
	...
	LangString CPro_CloseWinamp_MenuItem1			${LANG_RUSSIAN} "Закрыть"
	LangString CPro_CloseWinamp_MenuItem2			${LANG_RUSSIAN} "Скопировать список"
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_RUSSIAN} "С помощью этого мастера вы сможете установить $(^NameDA).$\r$\n$\r$\nДля работы компонента $\"${CPRO_WIDGET_NAME}$\" потребуется Winamp ${CPRO_WINAMP_SHORT_VERSION} и аддон ${CPRO_NAME} ${CPRO_VERSION}!$\r$\n$\r$\n$_CLICK"
