...
; Language selection
	LangString CPro_Language_Title ${LANG_RUSSIAN} "Installer language"
	LangString CPro_Language_Text ${LANG_RUSSIAN} "Please select a language:"

; First Page of Installer
	LangString CPro_Welcome_Title ${LANG_RUSSIAN} "Welcome to the $(^NameDA) Setup Wizard"
	LangString CPro_Welcome_Text ${LANG_RUSSIAN} "This wizard will guide you through the installation of $(^NameDA).$\r$\n$\r$\nIt is recommended that you close Winamp before starting Setup. This will make it possible to update all relevant Winamp files.$\n$\nYou'll at least need Winamp ${CPRO_WINAMP_VERSION} for this version of ${CPRO_NAME} to work!$\r$\n$\r$\n$_CLICK"
...
; Installer sections
	LangString CPro_CProFiles ${LANG_RUSSIAN} "ClassicPro Engine"
	LangString CPro_wBrowserPro ${LANG_RUSSIAN} "BrowserPro v2.0"
	LangString CPro_wAlbumArt ${LANG_RUSSIAN} "AlbumArt v1.1"
	LangString CPro_WidgetsSection ${LANG_RUSSIAN} "Widgets"
	LangString CPro_CProCustom ${LANG_RUSSIAN} "Components"
	LangString CPro_cPlaylistPro ${LANG_RUSSIAN} "Playlist Search"
		
; Installer sections descriptions	
	LangString CPro_Desc_CProFiles ${LANG_RUSSIAN} "This will install all the files that ClassicPro needs to work."
	LangString CPro_Desc_wBrowserPro ${LANG_RUSSIAN} "BrowserPro is a widget that will enable your browser to auto navigate to popular websites and explore the playing directory."
	LangString CPro_Desc_wAlbumArt ${LANG_RUSSIAN} "AlbumArt is a widget that shows a big cd cover and information about the playing file."
	LangString CPro_Desc_WidgetsSection ${LANG_RUSSIAN} "ClassicPro skins support widgets and here you'll find some of them that we decided to bundle with this installer."
	LangString CPro_Desc_CProCustom ${LANG_RUSSIAN} "Optional components for ClassicPro."
	LangString CPro_Desc_cPlaylistPro ${LANG_RUSSIAN} "Add a search box above your playlist for easy searches in your playlist."
...
; Finish Page	
	LangString CPro_FinishPage_1 ${LANG_RUSSIAN} "${CPRO_NAME}${CPRO_CRS} v${CPRO_VERSION} installation finished"
	LangString CPro_FinishPage_2 ${LANG_RUSSIAN} "The setup wizard have finished installing ${CPRO_NAME} v${CPRO_VERSION}. You can now start using ${CPRO_NAME} skins and widgets in Winamp."
	LangString CPro_FinishPage_3 ${LANG_RUSSIAN} "If you like ${CPRO_NAME} and would like to help future development of the product please donate to the project."
	LangString CPro_FinishPage_4 ${LANG_RUSSIAN} "What do you want to do now?"
	LangString CPro_FinishPage_5 ${LANG_RUSSIAN} "Go to our homepage to get more ${CPRO_NAME} skins and widgets"
	LangString CPro_FinishPage_6 ${LANG_RUSSIAN} "Open the default ${CPRO_NAME} skin now"
	LangString CPro_FinishPage_7 ${LANG_RUSSIAN} "Finish"	
	
; First Page of Uninstaller
	LangString CPro_Un_Welcome_Title ${LANG_RUSSIAN} "Welcome to the $(^NameDA) Uninstall Wizard"
	LangString CPro_Un_Welcome_Text ${LANG_RUSSIAN} "This wizard will guide you through the uninstallation of $(^NameDA).$\r$\n$\r$\nBefore starting the uninstallation, make sure ${CPRO_NAME}${CPRO_CRS} v${CPRO_VERSION} is not running.$\r$\n$\r$\n$_CLICK"
...
; First Page of Installer
	...
	LangString CPro_Widget_Name_Text ${LANG_RUSSIAN} "${CPRO_WIDGET_NAME} v${CPRO_WIDGET_VERSION} widget for ClassicPro©"		
...
; Finish Page	
	...
	LangString CPro_Widget_FinishPage_2 ${LANG_RUSSIAN} "The setup wizard have finished installing ${CPRO_WIDGET_NAME} v${CPRO_WIDGET_VERSION}. You can now start using your new ${CPRO_WIDGET_NAME} widget for ${CPRO_NAME} in Winamp."
	...
	LangString CPro_Widget_FinishPage_5 ${LANG_RUSSIAN} "Go to our homepage to get more ${CPRO_NAME} skins and widgets"
	LangString CPro_Widget_FinishPage_6 ${LANG_RUSSIAN} "Open the default ${CPRO_NAME} skin now"
