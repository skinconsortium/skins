...
; Installer sections
	...
	LangString CPro_wBrowserPro ${LANG_FRENCH} "BrowserPro v2.0"
...
; Installer sections descriptions	
	...
	LangString CPro_Desc_wAlbumArt ${LANG_FRENCH} "AlbumArt is a widget that shows a big cd cover and information about the playing file."
