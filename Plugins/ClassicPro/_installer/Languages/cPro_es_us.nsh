...
; Finish Page	
	...
	LangString CPro_FinishPage_4 ${LANG_SPANISH_INTERNATIONAL} "Terminar"
	LangString CPro_FinishPage_5 ${LANG_SPANISH_INTERNATIONAL} "Que desea hacer ahora?"
	LangString CPro_FinishPage_6 ${LANG_SPANISH_INTERNATIONAL} "Ir a nuestro sitio Web para obtener más carátulas de ${CPRO_NAME}"
	LangString CPro_FinishPage_7 ${LANG_SPANISH_INTERNATIONAL} "Run Winamp"
	LangString CPro_FinishPage_8 ${LANG_SPANISH_INTERNATIONAL} "Set ${CPRO_NAME} as default skin"	
