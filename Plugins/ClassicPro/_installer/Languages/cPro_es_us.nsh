...
; Installer sections
	...
	LangString CPro_wBrowserPro ${LANG_SPANISH_INTERNATIONAL} "BrowserPro v2.0"
	LangString CPro_wAlbumArt ${LANG_SPANISH_INTERNATIONAL} "AlbumArt v1.1"
...
; Installer sections descriptions	
	...
	LangString CPro_Desc_wAlbumArt ${LANG_SPANISH_INTERNATIONAL} "AlbumArt is a widget that shows a big cd cover and information about the playing file."
...
; First Page of Installer
	...
	LangString CPro_Widget_Name_Text ${LANG_SPANISH_INTERNATIONAL} "${CPRO_WIDGET_NAME} v${CPRO_WIDGET_VERSION} widget for ClassicPro©"		
