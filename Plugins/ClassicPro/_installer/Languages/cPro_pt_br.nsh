...
; Finish Page	
	...
	LangString CPro_FinishPage_4	${LANG_PORTUGUESE_BRAZILIAN} "Finalizar"
	LangString CPro_FinishPage_5	${LANG_PORTUGUESE_BRAZILIAN} "O que deseja fazer agora?"
	LangString CPro_FinishPage_6	${LANG_PORTUGUESE_BRAZILIAN} "Ir para o site e baixar Skins ${CPRO_NAME} e Widgets."
	LangString CPro_FinishPage_7	${LANG_PORTUGUESE_BRAZILIAN} "Abrir Winamp"
	LangString CPro_FinishPage_8	${LANG_PORTUGUESE_BRAZILIAN} "Definir ${CPRO_NAME} como skin padrão"	
...
; Warnings	
	LangString CPro_Warning_CreateMutex		${LANG_PORTUGUESE_BRAZILIAN} "A instalação do ${CPRO_NAME} v${CPRO_VERSION} está em execução."
	LangString CPro_Warning_No_Winamp		${LANG_PORTUGUESE_BRAZILIAN} "Winanmp não foi detectado em seu sistema.$\r$\nPor favor instale a versão recendo Winamp do site Winamp.com,$\r$\nantes de instalar ${CPRO_NAME} v${CPRO_VERSION}.$\r$\nInstalação será abortada."
	LangString CPro_Warning_Low_Version		${LANG_PORTUGUESE_BRAZILIAN} "${CPRO_NAME} v${CPRO_VERSION} requer pelo menos Winamp ${CPRO_WINAMP_VERSION} ou superior.$\r$\nPor favor primeiro atualize seu Winamp (Versão atual: $R0).$\r$\nInstalação será abortada."
	LangString CPro_Warning_AtLeast_2000	${LANG_PORTUGUESE_BRAZILIAN} "Desculpe, seu sistema não é suportado. ${CPRO_NAME} v${CPRO_VERSION} só funciona a partir do Windows 2000.$\r$\nInstalação será abortada."
...
; Close all instances of Winamp
	...
	LangString CPro_CloseWinamp_MenuItem1 		${LANG_PORTUGUESE_BRAZILIAN} "Fechar"
	LangString CPro_CloseWinamp_MenuItem2 		${LANG_PORTUGUESE_BRAZILIAN} "Copiar lista"
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_PORTUGUESE_BRAZILIAN} "O Instalador o guiará na instalação do $(^NameDA).$\r$\n$\r$\nÉ preciso ter o Winamp ${CPRO_WINAMP_SHORT_VERSION} e o ${CPRO_NAME} ${CPRO_VERSION} para esta versão do ${CPRO_WIDGET_NAME} funcionar perfeitamente!$\r$\n$\r$\n$_CLICK"
