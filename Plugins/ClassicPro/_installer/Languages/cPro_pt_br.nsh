...
; Installer sections descriptions	
	...
	LangString CPro_Desc_WidgetsSection ${LANG_PORTUGUESE_BRAZILIAN} "Esta opção instala Skins ${CPRO_NAME}, widgets suportados pelo ClassicPro."
...
; Cleanup Page	
	...
	LangString CPro_CleanupPage_Caption0 ${LANG_PORTUGUESE_BRAZILIAN} "Usando as opções desta página irá remover algumas Configurações de arquivos do Winamp que pode não trabalhar por versões diferentes de ambos Winamp e ${CPRO_NAME}."
	LangString CPro_CleanupPage_Caption1 ${LANG_PORTUGUESE_BRAZILIAN} "Se você tem problemas com o ${CPRO_NAME} que não executa corretamente, você pode reinstalar o ${CPRO_NAME} e usar esta página para resolver seus problemas."
	LangString CPro_CleanupPage_Caption2 ${LANG_PORTUGUESE_BRAZILIAN} "NOTA: Sem problemas, os arquivos serão reconstruídos pelo Winamp."
	...
	LangString CPro_CleanupPage_TSLink ${LANG_PORTUGUESE_BRAZILIAN} "Peça suporte free nos Fórum Skin Consortium."
	LangString CPro_CleanupPage_StudioXnf ${LANG_PORTUGUESE_BRAZILIAN} "Deletar Configuração de Skin (studio.xnf)"
	LangString CPro_CleanupPage_StudioXnf_Desc ${LANG_PORTUGUESE_BRAZILIAN} "Deleta especificações das skins como: posições de janela, abas ativas, modo de janela atual, ..."
	LangString CPro_CleanupPage_WinampIni ${LANG_PORTUGUESE_BRAZILIAN} "Deletar Configuração do Winamp (winamp.ini)"
	LangString CPro_CleanupPage_WinampIni_Desc ${LANG_PORTUGUESE_BRAZILIAN} "Deletar especificações do winamp como: skin atual, formatação avançada de titulo, idioma atual, ..."
...
; Close all instances of Winamp
	LangString CPro_CloseWinamp_Welcome_Title ${LANG_PORTUGUESE_BRAZILIAN} "Programa(s) para fechar"
	LangString CPro_CloseWinamp_Welcome_Text  ${LANG_PORTUGUESE_BRAZILIAN} "Programa(s) que deve(m) ser fechado(s) antes de continuar instalação"	
	LangString CPro_CloseWinamp_Heading ${LANG_PORTUGUESE_BRAZILIAN} "Feche o(s) programa(s) da lista antes de continuar instalação..."
	LangString CPro_CloseWinamp_Searching ${LANG_PORTUGUESE_BRAZILIAN} "Buscando programa(s), por favor espere..."
	LangString CPro_CloseWinamp_EndSearch ${LANG_PORTUGUESE_BRAZILIAN} "Busca(s) por programa(s) finalizada..."
