...
Global ConfigAttribute cover_dirs_sld_attrib;
...
Global ConfigVisAttribute vis_analyzerstyle_attrib;

Global ConfigAttribute lightmode_attrib;
...
Global ConfigAttribute party_frame1_attrib;
Global ConfigAttribute party_frame2_attrib;
Global ConfigAttribute party_frame3_attrib;
Global ConfigAttribute party_frame4_attrib;

Global ConfigAttribute atf_time_attrib;

Global ConfigAttribute atfset_toggle_attrib;

Global ConfigAttribute songticker_speed_attrib;
...
//Titan Preferences > Visualization
	...
	vis_analyzerstyle_attrib = custom_page_nonexposed.newAttribute("analyzerstyle", "0");
...
//Titan Preferences > CoverSearch
	...
	cover_dirs_pip_attrib = custom_page_cover.newAttribute("Search in playitem directory (simple)", "1");
	cover_dirs_sld_attrib = custom_page_cover.newAttribute("Search for any JPG file", "0");
...
//Non Exposed
	...
	lightmode_attrib = custom_page_nonexposed.newAttribute("LightMode", "*User");

	party_frame1_attrib = custom_page_nonexposed.newAttribute("Vortex_fs_frame1", "Media Library");
	party_frame2_attrib = custom_page_nonexposed.newAttribute("Vortex_fs_frame2", "Playlist Editor");
	party_frame3_attrib = custom_page_nonexposed.newAttribute("Vortex_fs_frame3", "Video/AVS");
	party_frame4_attrib = custom_page_nonexposed.newAttribute("Vortex_fs_frame4", "Cover Art/Equalizer");

	//atf
	
	atf_time_attrib = custom_page_nonexposed.newAttribute("Deimos_atf_time", "2");

	atfset_toggle_attrib = custom_page_nonexposed.newAttribute("Deimos_atf_toggle", "0");
