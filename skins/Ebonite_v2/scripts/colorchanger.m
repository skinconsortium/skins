...
*/
	...
	if(icheckoverlay == 1)
	{
		cbOverlay.setChecked(1);
		myattrib_stdfrmBGOverlayEnabled.setData("1");
	}
	else
	{
		cbOverlay.setChecked(0);
...
RGBtoGamma()
{
	...
	if((myattrib_stdfrmBGEnabled.getdata()=="0") && (myattrib_stdfrmBGLCDTextEnabled.getdata()=="0") && (myattrib_stdfrmBGLCDEnabled.getdata()=="0"))
	{
		return;
	}
	//change all colours if all are checked
	if(myattrib_stdfrmBGEnabled.getdata()=="1" && myattrib_stdfrmBGLCDTextEnabled.getdata()=="1" && myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{
	...
	if(myattrib_stdfrmBGEnabled.getdata()=="1" && myattrib_stdfrmBGLCDTextEnabled.getdata()=="1")
	{
		iGammaRed = ((stringtointeger(myattrib_stdfrmBGREDColor.getData()) - 128) * 32);
		iGammaGreen = ((stringtointeger(myattrib_stdfrmBGGREENColor.getData()) - 128) * 32);
		iGammaBlue = ((stringtointeger(myattrib_stdfrmBGBLUEColor.getData()) - 128) * 32);
	...
	if(myattrib_stdfrmBGEnabled.getdata()=="1" && myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{
		iGammaRed = ((stringtointeger(myattrib_stdfrmBGREDColor.getData()) - 128) * 32);
		iGammaGreen = ((stringtointeger(myattrib_stdfrmBGGREENColor.getData()) - 128) * 32);
		iGammaBlue = ((stringtointeger(myattrib_stdfrmBGBLUEColor.getData()) - 128) * 32);
	...
	if(myattrib_stdfrmBGLCDTextEnabled.getdata()=="1")
	{
		iGammaRed = ((stringtointeger(myattrib_txtREDColor.getData()) - 128) * 32);
		iGammaGreen = ((stringtointeger(myattrib_txtGREENColor.getData()) - 128) * 32);
		iGammaBlue = ((stringtointeger(myattrib_txtBLUEColor.getData()) - 128) * 32);

		adjustrgb(iGammaRed, iGammaGreen, iGammaBlue);
		return;
	}
	
	if(myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{
		iGammaRed = ((stringtointeger(myattrib_lcdREDColor.getData()) - 128) * 32);
		iGammaGreen = ((stringtointeger(myattrib_lcdGREENColor.getData()) - 128) * 32);
		iGammaBlue = ((stringtointeger(myattrib_lcdBLUEColor.getData()) - 128) * 32);
...
redslider.onSetPosition(int newpos)
{
	...
	if(myattrib_stdfrmBGLCDTextEnabled.getdata()=="1")
	{		
		myattrib_txtREDColor.setData(integertostring(newpos));
	}
	
	if(myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{		
		myattrib_lcdREDColor.setData(integertostring(newpos));
	}
...
greenslider.onSetPosition(int newpos) 
{
	...
	if(myattrib_stdfrmBGLCDTextEnabled.getdata()=="1")
	{		
		myattrib_txtGREENColor.setData(integertostring(newpos));
	}

	if(myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{		
		myattrib_lcdGREENColor.setData(integertostring(newpos));
	}
...
blueslider.onSetPosition(int newpos) 
{
	...
	if(myattrib_stdfrmBGLCDTextEnabled.getdata()=="1")
	{		
		myattrib_txtBLUEColor.setData(integertostring(newpos));
	}
	
	if(myattrib_stdfrmBGLCDEnabled.getdata()=="1")
	{		
		myattrib_lcdBLUEColor.setData(integertostring(newpos));
	}
