...
load_full()
{
	...
	sSongTicker = LayoutFull.findObject("songticker");
	
	btnRepeat = LayoutFull.findObject("RPT");
	btnShuffle = LayoutFull.findObject("SHUF");
	btnCrossfade = LayoutFull.findObject("CFD");
	btnConfig = LayoutFull.findObject("CNFG");
	...
	btnPause = LayoutFull.findObject("Pause");
	btnPlay = LayoutFull.findObject("Play");
	btnStop = LayoutFull.findObject("Stop");
	btnNext = LayoutFull.findObject("Next");
	btnPrevious = LayoutFull.findObject("Prev");
	
	Seeker = LayoutFull.findObject("prog.slider.ghost");
	Volume = LayoutFull.findObject("vol.slider");
...
LayoutFull.onSetVisible(Boolean on)
{
	if(on)
	{	
		DoButtonStatus();	
