{capture assign=specialStyles}
	<link rel="stylesheet" type="text/css" media="screen" href="{@RELATIVE_APPFRAMESTUB_DIR}style/stub.css" />
{/capture}
