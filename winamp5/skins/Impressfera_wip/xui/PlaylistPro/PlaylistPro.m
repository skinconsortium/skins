...
doSearch(String input){
	...
	String history = getPublicString("impress.PlaylistPro.history", "");
	...
	setPublicString("impress.PlaylistPro.history", history);
...
fakeSB.onRightButtonDown(int x, int y){
	...
	if(result>0 && result<100){
		...
		setPublicString("impress.PlaylistPro.history", "");
	}
}
