...
void H_TreeItem::H_hook(ScriptObject *o) {
  ...
  if (!loaded || loaded != iter) {
    ontreeadd_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onTreeAdd", this);
    ontreeremove_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onTreeRemove", this);
    onselect_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onSelect", this);
    ondeselect_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onDeselect", this);
    onleftdoubleclick_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onLeftDoubleClick", this);
    onrightdoubleclick_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onRightDoubleClick", this);
    onchar_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onChar", this);
    onexpand_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onExpand", this);
    oncollapse_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onCollapse", this);
    onbeginlabeledit_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onBeginLabelEdit", this);
    onendlabeledit_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onEndLabelEdit", this);
    oncontextmenu_id= WASABI_API_MAKI->maki_addDlfRef(o->vcpu_getController(), "onContextMenu", this);
    loaded = 1;
  }
  inited=1;
}
