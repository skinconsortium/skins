...
void C_TreeItem::C_hook(ScriptObject *object) {
  ...
  if (!loaded || loaded != iter) {
    loaded = iter;
    getnumchildren_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getNumChildren", this);
    setlabel_id = WASABI_API_MAKI->maki_addDlfRef(controller, "setLabel", this);
    getlabel_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getLabel", this);
    ensurevisible_id = WASABI_API_MAKI->maki_addDlfRef(controller, "ensureVisible", this);
    getnthchild_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getNthChild", this);
    getchild_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getChild", this);
    getchildsibling_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getChildSibling", this);
    getsibling_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getSibling", this);
    getparent_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getParent", this);
    editlabel_id = WASABI_API_MAKI->maki_addDlfRef(controller, "editLabel", this);
    hassubitems_id = WASABI_API_MAKI->maki_addDlfRef(controller, "hasSubItems", this);
    setsorted_id = WASABI_API_MAKI->maki_addDlfRef(controller, "setSorted", this);
    setchildtab_id = WASABI_API_MAKI->maki_addDlfRef(controller, "setChildTab", this);
    issorted_id = WASABI_API_MAKI->maki_addDlfRef(controller, "isSorted", this);
    iscollapsed_id = WASABI_API_MAKI->maki_addDlfRef(controller, "isCollapsed", this);
    isexpanded_id = WASABI_API_MAKI->maki_addDlfRef(controller, "isExpanded", this);
    invalidate_id = WASABI_API_MAKI->maki_addDlfRef(controller, "invalidate", this);
    isselected_id = WASABI_API_MAKI->maki_addDlfRef(controller, "isSelected", this);
    ishilited_id = WASABI_API_MAKI->maki_addDlfRef(controller, "isHilited", this);
    sethilited_id = WASABI_API_MAKI->maki_addDlfRef(controller, "setHilited", this);
    collapse_id = WASABI_API_MAKI->maki_addDlfRef(controller, "collapse", this);
    expand_id = WASABI_API_MAKI->maki_addDlfRef(controller, "expand", this);
    gettree_id = WASABI_API_MAKI->maki_addDlfRef(controller, "getTree", this);
    ontreeadd_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onTreeAdd", this);
    ontreeremove_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onTreeRemove", this);
    onselect_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onSelect", this);
    ondeselect_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onDeselect", this);
    onleftdoubleclick_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onLeftDoubleClick", this);
    onrightdoubleclick_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onRightDoubleClick", this);
    onchar_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onChar", this);
    onexpand_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onExpand", this);
    oncollapse_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onCollapse", this);
    onbeginlabeledit_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onBeginLabelEdit", this);
    onendlabeledit_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onEndLabelEdit", this);
    oncontextmenu_id = WASABI_API_MAKI->maki_addDlfRef(controller, "onContextMenu", this);
  }
  inited = 1;
}
...
void C_TreeItem::setLabel(const char *label) {
  ASSERT(inited);
...
const char *C_TreeItem::getLabel() {
  ASSERT(inited);
...
int C_TreeItem::onEndLabelEdit(const char *newlabel) {
  ASSERT(inited);
