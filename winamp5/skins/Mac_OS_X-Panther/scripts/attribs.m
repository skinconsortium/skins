...
Global ConfigAttribute menubar_toolbar_attrib;
Global ConfigAttribute menubar_large_attrib;
Global ConfigAttribute menubar_small_attrib;
...
//Titan Preferences > Menus
	...
	sep = custom_page_menubars.newAttribute("sep901", ""); sep.setData("-");
	menubar_toolbar_attrib = custom_page_menubars.newAttribute("Show Toolbar", "1");
	sep = custom_page_menubars.newAttribute("sep901", ""); sep.setData("-");
	menubar_large_attrib = custom_page_menubars.newAttribute("Large Toolbar Icons", "1");
	menubar_small_attrib = custom_page_menubars.newAttribute("Small Toolbar Icons", "0");
...
//Non Exposed
	...
	colortheme_attrib = custom_page_nonexposed.newAttribute("colortheme_"+getSkinName(), "");
...
menubar_large_attrib.onDataChanged() {
  if (attribs_mychange) return;
  attribs_mychange = 1;
  if (getData() == "1") menubar_small_attrib.setData("0");
  if (getData() == "0") menubar_small_attrib.setData("1");
  attribs_mychange = 0;
}
menubar_small_attrib.onDataChanged() {
  if (attribs_mychange) return;
  attribs_mychange = 1;
  if (getData() == "1") menubar_large_attrib.setData("0");
  if (getData() == "0") menubar_large_attrib.setData("1");
  attribs_mychange = 0;
}
