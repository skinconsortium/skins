...
;Definitions
	...
	!define CPRO_WIDGET_BUILD "1"
	!define CPRO_WIDGET_XMLFILENAME "chapterlist.xml"
	!define CPRO_WIDGET_DATA_FOLDERNAME "Chapterlist"
	!define CPRO_WIDGET_NSISFILENAME "cpro-widget-Chapterlist.nsi"	
	!define CPRO_WIDGET_PAYPAL_LINK "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=donate%40skinconsortium%2ecom&item_name=SkinConsortium%20Donation&item_number=%3e%20for%20skin%3a%20ClassicPro&no_shipping=1&no_note=1&cn=Optional%20Message&tax=0¤cy_code=EUR&lc=GB&bn=PP%2dDonationsBF&charset=UTF%2d8"
	!define CPRO_WINAMP_VERSION "5.551"
	!define CPRO_NAME "ClassicPro"
	!define CPRO_CRS "©"	
	!define CPRO_VERSION "1.1b"
	...
	!define CPRO_WIDGET_AUTHOR "pjn123"
...
Section "$(CPro_Widget_Files)" "CPro_Widget_Sec_Files"
	...
	SetOutPath "$INSTDIR\Plugins\ClassicPro\engine\widgets\Data\${CPRO_WIDGET_DATA_FOLDERNAME}"
		...
		File "Data\${CPRO_WIDGET_DATA_FOLDERNAME}\*.png"
...
Section "-Un.Uninstall"
	...
	Delete "$INSTDIR\Data\${CPRO_WIDGET_DATA_FOLDERNAME}\*.png"
