...
; Finish Page
	...
	LangString CPro_FinishPage_4 ${LANG_FRENCH} "Terminer"
	LangString CPro_FinishPage_5 ${LANG_FRENCH} "Que voulez-vous faire ?"
	LangString CPro_FinishPage_6 ${LANG_FRENCH} "Afficher le site de ${CPRO_NAME} pour plus de skins / gadgets"
	LangString CPro_FinishPage_7 ${LANG_FRENCH} "Lancer Winamp" 
    LangString CPro_FinishPage_8 ${LANG_FRENCH} "Définir ${CPRO_NAME} comme skin par défaut" 
...
; Close all instances of Winamp
    ...
    LangString CPro_CloseWinamp_MenuItem1		${LANG_FRENCH} "Fermer"
    LangString CPro_CloseWinamp_MenuItem2		${LANG_FRENCH} "Copier la liste"
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_FRENCH} "Cet assistant va vous guider pendant l'installation de $(^NameDA).$\r$\n$\r$\nVous devez utiliser Winamp ${CPRO_WINAMP_SHORT_VERSION} et ${CPRO_NAME} ${CPRO_VERSION} pour que la version de ${CPRO_WIDGET_NAME} fonctionne !$\r$\n$\r$\n$_CLICK"
