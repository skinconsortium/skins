...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text ${LANG_TURKISH} "Bu sihirbaz $(^NameDA) kurulumu boyunca size rehberlik edecek.$\r$\n$\r$\n${CPRO_WIDGET_NAME} eklentisi doðru bir þekilde çalýþabilmesi için, Winamp ${CPRO_WINAMP_VERSION} veya daha yüksek bir sürümü ve ${CPRO_NAME} ${CPRO_VERSION} bilgisayarýnzda yüklü olmasý gereklidir!$\r$\n$\r$\n$_CLICK"
