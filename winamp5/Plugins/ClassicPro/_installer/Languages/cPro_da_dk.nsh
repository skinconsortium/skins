...
; Finish Page	
	...
	LangString CPro_FinishPage_4 ${LANG_DANISH} "Afslut"	
	LangString CPro_FinishPage_5 ${LANG_DANISH} "Hvad vil du nu?"
	LangString CPro_FinishPage_6 ${LANG_DANISH} "Gå til vores hjemmeside for at få flere ${CPRO_NAME} skins og widgets"
	LangString CPro_FinishPage_7 ${LANG_DANISH} "Kor Winamp"
	LangString CPro_FinishPage_8 ${LANG_DANISH} "Valg ${CPRO_NAME} som standard skin"
...
; Close all instances of Winamp
	...
	LangString CPro_CloseWinamp_MenuItem1		${LANG_DANISH} "Luk"
	LangString CPro_CloseWinamp_MenuItem2		${LANG_DANISH} "Kopi liste"
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_DANISH} "Denne guide vil hjælpe dig igennem installationen af $(^NameDA).$\r$\n$\r$\nDu skal mindst have Winamp ${CPRO_WINAMP_SHORT_VERSION} og ${CPRO_NAME} ${CPRO_VERSION} for at denne version af ${CPRO_WIDGET_NAME} fungerer!$\r$\n$\r$\n$_CLICK"
