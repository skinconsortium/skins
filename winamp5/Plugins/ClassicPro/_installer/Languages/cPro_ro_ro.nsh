...
; Lang:				Romanian
; LangID			1048
; Last udpdated:	14/07/2010 13:31 EEST
...
; Finish Page
	...
	LangString CPro_FinishPage_4 ${LANG_ROMANIAN} "Terminare"
	LangString CPro_FinishPage_5 ${LANG_ROMANIAN} "Acþiuni dupã terminarea instalãrii:"
	LangString CPro_FinishPage_6 ${LANG_ROMANIAN} "Explorare pagina ${CPRO_NAME} ºi descãrcare interfeþe ºi gadgeturi"
	LangString CPro_FinishPage_7 ${LANG_ROMANIAN} "Lansare Winamp"
	LangString CPro_FinishPage_8 ${LANG_ROMANIAN} "Stabilire ${CPRO_NAME} ca faþetã implicitã"
...
; Close all instances of Winamp
	...
	LangString CPro_CloseWinamp_MenuItem1		${LANG_ROMANIAN} "Închidere"
	LangString CPro_CloseWinamp_MenuItem2		${LANG_ROMANIAN} "Copiere listã"
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_ROMANIAN} "Acest asistent vã va ghida în procesul de instalare a $(^NameDA).$\r$\n$\r$\nAveþi nevoie, cel puþin, de Winamp ${CPRO_WINAMP_SHORT_VERSION} ºi de ${CPRO_NAME} ${CPRO_VERSION} pentru ca aceastã versiune a ${CPRO_WIDGET_NAME} sã funcþioneze!$\r$\n$\r$\n$_CLICK"
