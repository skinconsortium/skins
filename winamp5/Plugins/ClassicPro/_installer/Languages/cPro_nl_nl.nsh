...
; Finish Page	
	...
	LangString CPro_FinishPage_4 ${LANG_DUTCH} "Klaar"
	LangString CPro_FinishPage_5 ${LANG_DUTCH} "Wat wilt u nu doen?"
	LangString CPro_FinishPage_6 ${LANG_DUTCH} "Ga naar onze homepage voor meer ${CPRO_NAME} skins and widgets"
	LangString CPro_FinishPage_7 ${LANG_DUTCH} "Run Winamp"
	LangString CPro_FinishPage_8 ${LANG_DUTCH} "Set ${CPRO_NAME} as default skin"	
...
; First Page of Installer
	...
	LangString CPro_Widget_Welcome_Text		${LANG_DUTCH} "Deze wizard zal u helpen bij de installatie van $(^NameDA).$\r$\n$\r$\nU hebt tenminste Winamp ${CPRO_WINAMP_SHORT_VERSION} en ${CPRO_NAME} ${CPRO_VERSION} om deze versie van ${CPRO_WIDGET_NAME} correct te laten werken!$\r$\n$\r$\n$_CLICK"
